{{#if showFacet}}
	<div class="facets-faceted-navigation-item-range-facet-group" id="{{htmlId}}" data-type="rendered-facet" data-facet-id="{{facetId}}">
		...
		{{else}}
			<a href="#" class="facets-faceted-navigation-item-range-facet-group-expander collapsed" data-toggle="collapse" data-target="#{{htmlId}}-category-wrapper" data-type="collapse" title="{{facetDisplayName}}">
		...
		<div class="facets-faceted-navigation-item-range-facet-group-wrapper">
			{{else}}
			<div class="facets-faceted-navigation-item-range-facet-group-wrapper {{#if isCollapsed}} collapse in{{/if}}" id="{{htmlId}}-category-wrapper">
				{{/if}}
