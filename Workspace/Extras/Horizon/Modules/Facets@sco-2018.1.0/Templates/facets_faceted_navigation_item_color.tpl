{{#if showFacet}}
	<div class="facets-faceted-navigation-item-color-facet-group" id="{{htmlId}}" data-type="rendered-facet" data-facet-id="{{facetId}}">
		{{#if showHeading}}
			...
			{{else}}
				<a href="#" class="facets-faceted-navigation-item-color-facet-group-expander collapsed" data-toggle="collapse" data-target="#{{htmlId}}-category-wrapper" data-type="collapse" title="{{facetDisplayName}}">
					<i class="facets-faceted-navigation-item-color-facet-group-expander-icon"></i>
		...
		<div class="facets-faceted-navigation-item-color-facet-group-wrapper">
			{{else}}
				...
				<div class="facets-faceted-navigation-item-color-facet-group-wrapper {{#if isCollapsed}} collapse in{{/if}}" id="{{htmlId}}-category-wrapper">
					{{/if}}
