{{#if showFacet}}
	<div class="facets-faceted-navigation-item-category">
		...
		{{else}}
			<a href="#" class="facets-faceted-navigation-item-category-facet-group-expander collapsed" data-toggle="collapse" data-target="#{{htmlId}}-category-wrapper" data-type="collapse" title="{{translate 'Category'}}">
		...
		<div class="facets-faceted-navigation-item-category-facet-group" data-type="rendered-facet" data-facet-id="{{facetId}}"  id="{{htmlId}}">
			<div class="{{#if isCollapsed}} collapse in {{/if}} facets-faceted-navigation-item-category-facet-group-wrapper" id="{{htmlId}}-category-wrapper">
