{{#if showFacet}}
	<div class="facets-faceted-navigation-item-facet-group" id="{{htmlId}}" data-type="rendered-facet" data-facet-id="{{facetId}}">
		{{#if showHeading}}
			...
			{{else}}
				<a href="#" class="facets-faceted-navigation-item-facet-group-expander collapsed" data-toggle="collapse" data-target="#{{htmlId}}-category-wrapper" data-type="collapse" title="{{facetDisplayName}}">
		...
		<div class="{{#if isCollapsed}} collapse {{/if}} facets-faceted-navigation-item-facet-group-wrapper" id="{{htmlId}}-category-wrapper">
