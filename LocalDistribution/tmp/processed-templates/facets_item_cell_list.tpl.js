define('facets_item_cell_list.tpl', ['Handlebars','Handlebars.CompilerNameLookup'], function (Handlebars, compilerNameLookup){ var t = {"1":function(container,depth0,helpers,partials,data) {
  ...
  return "\n<div class=\"facets-item-cell-list\" itemprop=\"itemListElement\"  data-item-id=\""
    ...
    + ((stack1 = ((helper = (helper = compilerNameLookup(helpers,"storedescription") || (depth0 != null ? compilerNameLookup(depth0,"storedescription") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"storedescription","hash":{},"data":data}) : helper))) != null ? stack1 : "")
    + "\n        </p>\n    </div>\n</div>\n\n\n\n\n";
},"useData":true}; var main = t.main; t.main = function(){ arguments[1] = arguments[1] || {}; var ctx = arguments[1]; ctx._extension_path = 'http://localhost:7777/tmp/extensions/SC/Horizon/3.0.7/'; ctx._theme_path = 'http://localhost:7777/tmp/extensions/SC/Horizon/3.0.7/'; return main.apply(this, arguments); }; var template = Handlebars.template(t); template.Name = 'facets_item_cell_list'; return template;});